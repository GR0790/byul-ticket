      ...
      questions: [
        {
          ...
          answer:
            "소액결제현금화는 개인에게 부여된 휴대폰 소액결제 한도를 사용하여, 모바일 상품권 등 디지털 상품을 구매한 뒤 이를 판매하여 현금으로 전환하는 서비스입니다. SKT, KT, LG U+ 등 모든 통신사 고객님이 이용 가능하며, 저희 고릴라티켓는 업계 최고 수준의 지급률로 신속하고 안전한 서비스를 제공합니다.",
        },
        {
          question: "소액결제현금화는 합법적인가요?",
          answer:
            "네, 정식 사업자 등록을 한 업체를 통해 개인의 소액결제 한도를 활용하는 것은 불법이 아닙니다. 다만, 미등록 업체나 사기 업체 이용 시 피해가 발생할 수 있으므로 반드시 안전한 업체를 선택해야 합니다. 고릴라티켓는 정식 사업자등록을 마친 합법적인 업체이므로 안심하고 이용하실 수 있습니다.",
        },
        {
          question: "소액결제현금화 지급률은 무엇을 의미하나요?",
          answer:
            "지급률은 결제하신 금액 대비 실제로 입금받으시는 현금의 비율을 의미합니다. 예를 들어 지급률이 80%라면, 10만원을 결제했을 때 8만원을 입금받게 됩니다. 고릴라티켓는 불필요한 운영비를 줄여 업계 최고 수준의 지급률로 고객님께 최대한 많은 혜택을 드리기 위해 노력합니다.",
        },
        {
          question: "신청부터 입금까지 시간은 얼마나 걸리나요?",
          answer:
            "고릴라티켓는 평균 3분 이내 입금 완료를 자랑합니다. 신청부터 상담, 결제 확인, 입금까지 모든 절차가 5분을 넘지 않도록 24시간 신속하게 처리해 드리고 있습니다.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "네, 가능합니다. 고릴라티켓는 24시간 연중무휴 운영되며 신청 즉시 처리가 이루어집니다. 평균 3분 이내 입금 완료를 목표로 하므로, 급하게 현금이 필요하신 경우에도 소액결제현금화를 당일 바로 해결하실 수 있습니다.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "매우 간단한 4단계로 진행됩니다. <strong>1) 고릴라티켓 1:1 상담 신청 → 2) 본인 확인 및 한도 조회 → 3) 상담원의 안내에 따른 안전 결제 진행 → 4) 결제 확인 후 3분 내 즉시 입금.</strong> <a href='/how-to-use' class='text-green-600 hover:underline'>이용 방법 페이지</a>에서 더 자세한 내용을 확인하실 수 있습니다.",
        },
        {
          question: "미납이나 정책 제한이 있어도 소액결제현금화가 가능한가요?",
          answer:
            "네, 가능합니다. 고릴라티켓는 미납·정책으로 인해 결제가 어려운 고객님들을 위한 특별 노하우를 보유하고 있으며, 업계 최고 수준인 99.9%의 승인률을 자랑합니다. 다른 업체에서 거절당했더라도 포기하지 마시고 먼저 상담받아보세요.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "네, 고릴라티켓는 24시간 운영으로 신청 즉시 처리해 드립니다. 신용카드현금화 역시 빠른 입금 처리를 목표로 하고 있으므로, 급하게 현금이 필요하신 경우에도 걱정 없이 당일 이용하실 수 있습니다.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          question: "고릴라티켓는 정말 안전한 업체인가요?",
          answer:
            "네, 고릴라티켓는 정식 사업자등록을 마친 합법적인 업체입니다. 월 3만건 이상의 풍부한 거래실적과 99.9%의 고객만족도가 안전성을 증명합니다. 또한 모든 상담 및 거래 정보는 SSL 보안 시스템으로 암호화되어 안전하게 보호됩니다.",
        },
        {
          question: "사기 업체와 어떻게 구별하나요?",
          answer:
            "안전한 업체를 구별하는 방법은 다음과 같습니다. <strong>1) 정식 사업자등록번호 공개 여부 2) 웹사이트 내 고정 연락처 유무 3) 비정상적으로 높은 지급률(90% 이상)을 제시하지 않는지 4) 선입금이나 과도한 개인정보를 요구하지 않는지</strong> 등을 확인해야 합니다. 고릴라티켓는 이 모든 조건을 만족하는 검증된 업체입니다.",
        },
      ],
    },
  ];
